...
internal class UITests : CoreTestsFixture
{
    ...
    public IEnumerator UI_DisplayIndexMatchesDisplayWithTouchscreenOnScreenSpaceCanvas()
    {
        ...
        // Touch Display 1
        BeginTouch(1, new Vector2(100, 100), queueEventOnly: true, displayIndex: targetDisplay);
        yield return null;
        EndTouch(1, new Vector2(100, 100), queueEventOnly: true, displayIndex: targetDisplay);
        yield return null;
    ...
    public IEnumerator UI_DisplayIndexMatchesDisplayMultiplePointers()
    {
        ...
        foreach (var parentReceiverEvent in scene.parentReceiver.events)
        {
            Assert.AreEqual(targetDisplay, parentReceiverEvent.pointerData.displayIndex);
        }
    ...
    public void ButtonClickTest()
    {
        ...
        //ClickBothButtonOnCanvasOverlayMode&CameraMode
        ChangeCanvasRenderMode(leftEyeCanvas, RenderMode.ScreenSpaceOverlay);
        ChangeCanvasRenderMode(rightEyeCanvas, RenderMode.ScreenSpaceCamera);
        ClickButton(leftButton);
        ClickButton(rightButton);
    ...
    [UnityTest]
    public IEnumerator DragImageTest()
    {
        ...
        m_Canvas.targetDisplay = 0; //set 1 on secondary screen
        ...
        m_FakeBaseInput.MousePosition = m_Image.GetComponent<RectTransform>().position; 
        ...
        m_FakeBaseInput.MouseButtonDown[0] = false; //important!
